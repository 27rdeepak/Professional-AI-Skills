...
description: Evaluate claims, assumptions, evidence, logic, and alternative explanations. Use when a user asks for this professional analysis or needs a structured, evidence-aware judgment in this domain.
---
...
1. Restate the claim and its decision consequence.
2. Assess evidence quality, relevance, independence, and gaps.
3. Test causal claims against alternatives and base rates.
4. State what would change the conclusion.
...
Default to a **claim–evidence–judgment review** with:
...
**Request:** “Use $critical-thinking to analyze this material.”
