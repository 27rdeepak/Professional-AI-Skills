...
description: Prepare the purpose, facts, emotions, boundary, and desired outcome|Separate the issue from the person and the system|Anticipate reactions and de-escalation options|Recommend language, timing, and a next-step contract. Use when a user asks for this professional analysis or needs a structured, evidence-aware judgment in this domain.
---
...
**Request:** “Use difficult-conversations to analyze this material.”
